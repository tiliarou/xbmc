...
public:
  ...
  void SetProcessInfo(CRPProcessInfo *processInfo) { m_processInfo = processInfo; }
...
class CMMALRenderer : public CRPBaseRenderer, public CThread, public IRunnable
{
public:
  CMMALRenderer();
  ~CMMALRenderer();
  ...
  virtual void         AddRPVideoPictureHW(RPVideoPicture& pic, int index);
