...
class CRPRendererMediaCodecSurface : public CRPBaseRenderer
{
public:
  CRPRendererMediaCodecSurface();
  virtual ~CRPRendererMediaCodecSurface();
  ...
  virtual int GetImage(YV12ImageRP *image, int source = -1, bool readonly = false);
