...
#include <string>
#include <sstream>
#include "VideoRenderers/VideoShaders/ShaderFormats.h"
                                             ...
                                             GLSLOutput *output)
{
  ...
  if (m_format == RP_SHADER_YV12 ||
      m_format == RP_SHADER_YV12_10 ||
      m_format == RP_SHADER_YV12_16)
    m_defines += "#define XBMC_YV12\n";
  else if (m_format == RP_SHADER_NV12)
    m_defines += "#define XBMC_NV12\n";
  else if (m_format == RP_SHADER_YUY2)
    m_defines += "#define XBMC_YUY2\n";
  else if (m_format == RP_SHADER_UYVY)
    m_defines += "#define XBMC_UYVY\n";
  else if (m_format == RP_SHADER_NV12_RRG)
